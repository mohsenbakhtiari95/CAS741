...
\section{Goals}
\begin{enumerate}
    \item Produce a maintainable software system for coupled hydro-thermal-chemical-mechanical simulations of porous media.
    \item Accurately simulate coupled multi-phase flow, heat transfer, chemical transport, and mechanical damage processes.
    \item Support systematic verification and validation of simulation results.
    \item Provide a software system that is usable by researchers and graduate students.
    \item Enable future extension of the software to additional physical models and application domains.
\end{enumerate}
